...
import { processCityUpload } from '../../../../../server/media';
      ...
      try {
        ...
        for (const [fileIndex, file] of files.entries()) {
          send({
            ...
            fileName: file.name,
            overall: Math.round((fileIndex / files.length) * 100),
          });
          photos.push(await processCityUpload(placeId, file, alt, caption, (progress) => {
